...
function convertValues() {
    ...
    const currencyValueToConvert = document.querySelector(".moeda-valor")
    const currencyValueConverted = document.querySelector(".moeda-valor-convertida")
...
function chargeCurrency() {
    const currencyName = document.querySelector(".moeda-us")
